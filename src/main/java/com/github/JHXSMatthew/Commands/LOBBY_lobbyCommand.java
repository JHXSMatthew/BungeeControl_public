...
public class LOBBY_lobbyCommand extends Command{
	public LOBBY_lobbyCommand(){
	      super("lobby");
	  }
		...
		public void execute(CommandSender arg0, String[] arg1) {
		    ...
		    if(!Core.getLbc().Canteleport(p)){
		    	p.sendMessage(new TextComponent(ChatColor.RED + "YourCraft >> 您将被传送至大厅，请您在5秒内再次输入 /lobby 确认该操作。"));
		    	return ;
		    }
