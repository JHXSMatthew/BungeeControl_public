...
public class AntiCheat implements Listener{
	...
	private List<String> code = Collections.synchronizedList(new ArrayList<String> ());
	...
	private void register(){
		...
		Core.get().getProxy().registerChannel("WDL|INIT");
		Core.get().getProxy().registerChannel("PERMISSIONREPL");
	}
